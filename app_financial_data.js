...
//////////////////////////////////////////////////////////////////////
    ...
    featuretable.addRow(Open);
    featuretable.addRow(Close);
    featuretable.addRow(stock_high);
    featuretable.addRow(stock_low);
    featuretable.addRow(Volume);
...
//////////////////////////////////////////////////////////////////////
    ...
    featuretable.addRow(MACD_sl);
    featuretable.addRow(MACD_h);
...
//////////////////////////////////////////////////////////////////////
    ...
    for(let i=0;i<13;i++){High.push(0);}

    for(let i=0;i<13;i++){Low.push(0);}
...
//////////////////////////////////////////////////////////////////////
    ...
    for(let i=0;i<14;i++){avg14.push(0);}
...
//////////////////////////////////////////////////////////////////////
    ...
    for(let i=0;i<28;i++){avg28.push(0);}
...
table = getTable(stock,start,end);

system.out.exportToExcel(table);// Export to Excel
